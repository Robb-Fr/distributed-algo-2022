...
public class BestEffortBroadcast implements Deliverable {
    ...
    public BestEffortBroadcast(byte myId, Map<Byte, Host> hostsMap, Deliverable parent,
    ...
    public BestEffortBroadcast(byte myId, Map<Byte, Host> hostsMap) throws SocketException, UnknownHostException {
        if (hostsMap == null) {
